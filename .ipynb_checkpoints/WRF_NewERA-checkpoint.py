...
class mapa ():
    ...
    def cargar_var(_):
        ...
        _.qvtend = to_np(_.data_wb.variables['QVTTEND'])
        _.conv_wv = to_np(_.data_wb.variables['WBACF'])
        _.qvh_adv = to_np(_.data_wb.variables['QVH_ADV'])
    ...
    def eje_wb_1(_,ax,i):
        ...
        conv_wv= _.conv_wv[i,pad:-pad,pad:-pad]
