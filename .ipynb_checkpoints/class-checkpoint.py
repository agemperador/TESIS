class mapa ():
    ...
    def crear_mapa_WB (_,i,gs = [5,4], save = False, carpeta = './', k=0):
    ...
    def crear_mapa_SC_Madura(_,i,gs = [5,6], save = False, carpeta = './',k =0):
    ...
    def crear_mapa_SC_CI (_,i,k,gs = [5,6], save = False, carpeta = './'):
    ...
    def crear_mapa_SC_formacion (_,i,k,gs = [5,6], save = False, carpeta = './'):
